...
> `authn-k8s.yaml` builds on top of `app-vars.yaml` in <https://joetanx.github.io/conjur-master>. Loading `authn-k8s.yaml` without having `app-vars.yaml` loaded previously will not work.
```console
